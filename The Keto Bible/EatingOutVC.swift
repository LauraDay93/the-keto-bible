...
class EatingOutVC : UIViewController, UIScrollViewDelegate  {
    ...
    override func viewDidLoad() {
        ...
        if StyleManager.isIpad() {
            self.bgVC = UIImageView(image: UIImage(named: "eatingOutIpad"))
        } else {
            self.bgVC = UIImageView(image: UIImage(named: "eatingOutScreen"))
        }
        ...
        bgVC.snp.makeConstraints { (make) in
            if StyleManager.isIpad() {
                ...
                if UIDevice().type == .iPhoneSE ||  UIDevice().type == .iPhone5S || UIDevice().type == .iPhone5C || UIDevice().type == .iPhone5 || UIDevice().type == .iPhone8 || UIDevice().type == .iPhone7 || UIDevice().type == .iPhone6 || UIDevice().type == .iPhone6S || UIDevice().type == .iPhone7Plus || UIDevice().type == .iPhone8Plus || UIDevice().type == .iPhone6Plus || UIDevice().type == .iPhone6SPlus {
        ...
        if UIDevice().type == .iPhoneSE ||  UIDevice().type == .iPhone5S || UIDevice().type == .iPhone5C || UIDevice().type == .iPhone5 || UIDevice().type == .iPhone8 || UIDevice().type == .iPhone7 || UIDevice().type == .iPhone6 ||  UIDevice().type == .iPhone7Plus || UIDevice().type == .iPhone8Plus || UIDevice().type == .iPhone6Plus || UIDevice().type == .iPhone6SPlus ||  UIDevice().type == .iPhone6S {
